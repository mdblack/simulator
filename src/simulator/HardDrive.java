...
//			else
	...
	public short ioPortReadWord(int address)
	{
		switch(address-ioBase1)
		{
			case 0: case 1:
				...
				return word;
			default: return (short)((0xff&ioPortReadByte(address))|(0xff00&(ioPortReadByte(address+1)<<8)));
		}
	}
	public int ioPortReadLong(int address)
	{
		switch(address-ioBase1)
		{
			case 0: case 1: case 2: case 3:
				...
				return word;
			default: return(0xffff&ioPortReadWord(address))|(0xffff0000&(ioPortReadWord(address+2)<<16));
		}
	}
	...
	class Drive
	{
		...
		public void refreshGUI()
		{
			...
			if (computer.diskGUI[2+id]!=null) computer.diskGUI[2+id].redraw(name,cylinders,heads,sectors,disk);
			if (computer.sectorGUI[2+id]!=null) computer.sectorGUI[2+id].redraw(name,cylinders,heads,sectors,disk);
		}
