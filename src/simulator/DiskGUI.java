...
public class DiskGUI extends AbstractGUI
{
	...
	private void drawDisk(Graphics g)
	{
		...
		{
			case 0: g.setColor(COLOR_LASTOP); break;
			case 1: g.setColor(COLOR_READ); break;
			case 2: g.setColor(COLOR_WRITE); break;
			default: g.setColor(COLOR_TRACK_HIGHLIGHT); break;
		}
