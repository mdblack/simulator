...
This file is mostly taken verbatim from JPC (RealModeUBlock.java, author Chris Dennis)
...
Enumerates the errors that can go wrong during execution
*/
...
public final class ProcessorException extends RuntimeException
{
    ...
    public final boolean pointsToSelf;
