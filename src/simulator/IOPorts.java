...
public class IOPorts
{
	...
	public int ioPortReadByte(int address)
	{
		...
		if (computer.processor.processorGUICode!=null) computer.processor.processorGUICode.push(Processor.GUICODE.PORT_READ,address,b);
...
//		System.out.printf("Write to port %x\n",address);
		...
		if (computer.processor.processorGUICode!=null) computer.processor.processorGUICode.push(Processor.GUICODE.PORT_WRITE,address,data);
		if (computer.ioGUI!=null)
