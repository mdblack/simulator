...
//			if (computer.datapathBuilder!=null)
    ...
    public static class ControlPath extends ControlRow {
        ...
        public ControlPath(Computer computer, String name, ControlModule controlModule, boolean autoGenerate) {
            ...
            if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                computer.controlBuilder.drawingcomponent.add(label);
        }
        ...
        public void remove() {
            if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                computer.controlBuilder.drawingcomponent.remove(label);
...
//System.out.println("new control instruction: "+name);
            ...
            for (int i = 0; i < ci.length; i++) {
                ...
                if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                    computer.controlBuilder.drawingcomponent.add(controlInputName[i]);
                if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                    computer.controlBuilder.drawingcomponent.add(controlInputListPane[i]);
            }
            ...
            if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                computer.controlBuilder.drawingcomponent.add(controlInputLabel);
...
//System.out.println("control output: "+co[i]);
                ...
                if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                    computer.controlBuilder.drawingcomponent.add(controlOutputName[i]);
                if (t.equals("mux")) {
                ...
                if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                    controlOutputListPane[i].setBounds(computer.controlBuilder.defaultControl.field1width() + GAPWIDTH + (LABELWIDTH + TEXTWIDTH) * i, row * ROWHEIGHT + 1, TEXTWIDTH - 3, ROWHEIGHT - 2);
                if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                    computer.controlBuilder.drawingcomponent.add(controlOutputListPane[i]);
            }
        ...
        public void remove() {
            for (int i = 0; i < controlInputListPane.length; i++)
                if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                    computer.controlBuilder.drawingcomponent.remove(controlInputListPane[i]);
            for (int i = 0; i < controlOutputListPane.length; i++)
                if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                    computer.controlBuilder.drawingcomponent.remove(controlOutputListPane[i]);
            for (int i = 0; i < controlInputName.length; i++)
                if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                    computer.controlBuilder.drawingcomponent.remove(controlInputName[i]);
            for (int i = 0; i < controlOutputName.length; i++)
                if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                    computer.controlBuilder.drawingcomponent.remove(controlOutputName[i]);
            if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                computer.controlBuilder.drawingcomponent.remove(controlInputLabel);
        }
...
//			if (computer.datapathBuilder==null) return;
            ...
            for (int i = 0; i < controlOutputName.length; i++)
                if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                    controlOutputName[i].setBounds(computer.controlBuilder.defaultControl.field1width() + GAPWIDTH + (LABELWIDTH + TEXTWIDTH) * i + TEXTWIDTH, row * ROWHEIGHT + 1, LABELWIDTH - 3, ROWHEIGHT - 2);
            if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                controlInputLabel.setBounds(GAPWIDTH, row * ROWHEIGHT + 1, (LABELWIDTH + TEXTWIDTH) * computer.controlBuilder.defaultControl.field1width(), ROWHEIGHT - 2);
        }
...
//			}
            ...
            if (controlInputListPane != null)
                if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                    nextStateLabel.setBounds(GAPWIDTH + computer.controlBuilder.defaultControl.field1width(), row * ROWHEIGHT + 1, computer.controlBuilder.defaultControl.field2width() - GAPWIDTH * 2, ROWHEIGHT - 2);
            if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                computer.controlBuilder.drawingcomponent.add(nextStateLabel);
        }
        ...
        public void remove() {
            ...
            for (int i = 0; i < controlInputName.length; i++)
                if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                    computer.controlBuilder.drawingcomponent.remove(controlInputName[i]);
            if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                computer.controlBuilder.drawingcomponent.remove(nextStateLabel);
            if (computer.controlBuilder != null && module == computer.controlBuilder.defaultControl)
                computer.controlBuilder.drawingcomponent.remove(controlInputLabel);
        }
        ...
        public Vector getSelectedVector() {
            ...
            for (int i = 0; i < controlPaths.size(); i++) {
                ...
                for (int j = 0; j < ((ControlPath) (controlPaths.elementAt(i))).controlStates.size(); j++) {
                    ...
                    for (int k = 0; k < ((ControlState) (((ControlPath) (controlPaths.elementAt(i))).controlStates.elementAt(j))).controlInstructions.size(); k++) {
                        if (row == selectedRow)
                            return ((ControlState) ((ControlPath) controlPaths.elementAt(i)).controlStates.elementAt(j)).controlInstructions;
                        row++;
                    }
                    for (int k = 0; k < ((ControlState) (((ControlPath) (controlPaths.elementAt(i))).controlStates.elementAt(j))).nextStates.size(); k++) {
                        if (row == selectedRow)
                            return ((ControlState) ((ControlPath) controlPaths.elementAt(i)).controlStates.elementAt(j)).nextStates;
                        row++;
                    }
                }
            }
