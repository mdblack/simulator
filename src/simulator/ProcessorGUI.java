...
"reg0","reg1","addr","seg","memory","ports","ALU","dispALU","ipALU","spALU"};
	...
	public void makeBlocks()
	{
		...
		//ip alu
		ax=internalBlock[8].arrowOutX(); ay=internalBlock[8].arrowOutY(); bx=ax; by=ay+10; cx=ax-BXSIZE/2-10; cy=by; dx=cx; dy=registerBubble[0].arrowInY()-10; ex=registerBubble[0].arrowInX(); ey=dy; fx=ex; fy=registerBubble[0].arrowInY();
		...
		//sp alu
		ax=internalBlock[9].arrowOutX(); ay=internalBlock[9].arrowOutY(); bx=ax; by=ay+10; cx=ax-BXSIZE/2-8; cy=by; dx=cx; dy=registerBubble[1].arrowInY()-10; ex=registerBubble[1].arrowInX(); ey=dy; fx=ex; fy=registerBubble[1].arrowInY();
		...
		//addr alu
		ax=internalBlock[7].arrowOutX(); ay=internalBlock[7].arrowOutY(); bx=ax; by=ay+10; cx=ax+(BXSIZE-10); cy=by; dx=cx; dy=internalBlock[2].arrowInY()-10; ex=internalBlock[2].arrowInX(); ey=dy; fx=ex; fy=internalBlock[2].arrowInY();
		...
		//main alu out 0
		ax=internalBlock[6].arrowOutX1(); ay=internalBlock[6].arrowOutY(); bx=ax; by=ay+10; cx=ax-(BXSIZE*2-10); cy=by; dx=cx; dy=internalBlock[0].arrowInY()-10; ex=internalBlock[0].arrowInX(); ey=dy; fx=ex; fy=internalBlock[0].arrowInY();
		bus[1+23+23+6+6+6]=new Bus(new int[]{ax,ay,bx,by,bx,by,cx,cy,cx,cy,dx,dy,dx,dy,ex,ey,ex,ey,fx,fy});
		//main alu out 1
		ax=internalBlock[6].arrowOutX2(); ay=internalBlock[6].arrowOutY(); bx=ax; by=ay+10; cx=ax+(BXSIZE*2-10); cy=by; dx=cx; dy=internalBlock[1].arrowInY()-10; ex=internalBlock[1].arrowInX(); ey=dy; fx=ex; fy=internalBlock[1].arrowInY();
		...
		ax=850; ay=BUS1HEIGHT; bx=ax; by=instructionBlock.arrowInY()-10; cx=instructionBlock.arrowInX(); cy=by; dx=cx; dy=instructionBlock.arrowInY();
	...
	public void applyCode(Processor.GUICODE code, String name, String value)
	{
		...
		switch(code)
		{
			...
			case DECODE_SEGMENT_ADDRESS:
				if (name.equals("cs")) { registerBubble[CS].read(); bus[BUSCSOUT].access(); value=registerBubble[CS].getValue(); }
				if (name.equals("ss")) { registerBubble[SS].read(); bus[BUSSSOUT].access(); value=registerBubble[SS].getValue(); }
				if (name.equals("ds")) { registerBubble[DS].read(); bus[BUSDSOUT].access(); value=registerBubble[DS].getValue(); }
				if (name.equals("es")) { registerBubble[ES].read(); bus[BUSESOUT].access(); value=registerBubble[ES].getValue(); }
				if (name.equals("fs")) { registerBubble[FS].read(); bus[BUSFSOUT].access(); value=registerBubble[FS].getValue(); }
				if (name.equals("gs")) { registerBubble[GS].read(); bus[BUSGSOUT].access(); value=registerBubble[GS].getValue(); }
				bus[BUSMAIN].access();
				bus[BUSSEGIN].access();
			...
			case DECODE_MEMORY_ADDRESS:
				if (name.equals("ax")) {registerBubble[EAX].read(); bus[BUSEAXOUT].access(); tempvalue=registerBubble[EAX].getValue(); }
				if (name.equals("bx")) {registerBubble[EBX].read(); bus[BUSEBXOUT].access(); tempvalue=registerBubble[EBX].getValue(); }
				if (name.equals("cx")) {registerBubble[ECX].read(); bus[BUSECXOUT].access(); tempvalue=registerBubble[ECX].getValue(); }
				if (name.equals("dx")) {registerBubble[EDX].read(); bus[BUSEDXOUT].access(); tempvalue=registerBubble[EDX].getValue(); }
				if (name.equals("si")) {registerBubble[ESI].read(); bus[BUSESIOUT].access(); tempvalue=registerBubble[ESI].getValue(); }
				if (name.equals("di")) {registerBubble[EDI].read(); bus[BUSEDIOUT].access(); tempvalue=registerBubble[EDI].getValue(); }
				if (name.equals("sp")) {registerBubble[ESP].read(); bus[BUSESPOUT].access(); tempvalue=registerBubble[ESP].getValue(); }
				if (name.equals("bp")) {registerBubble[EBP].read(); bus[BUSEBPOUT].access(); tempvalue=registerBubble[EBP].getValue(); }
				if (name.equals("displacement")) {instructionBlock.readDisp(); bus[BUSDISPLACEMENT].access(); tempvalue=value; }
				bus[BUSMAIN].access();
				bus[BUSSEGIN].access();
			...
			case DECODE_INPUT_OPERAND_0:
				if (name.equals("ax")||name.equals("eax")||name.equals("ah")||name.equals("al")) {registerBubble[EAX].read(); bus[BUSEAXOUT].access(); }
				else if (name.equals("bx")||name.equals("ebx")||name.equals("bh")||name.equals("bl")) {registerBubble[EBX].read(); bus[BUSEBXOUT].access(); }
				else if (name.equals("cx")||name.equals("ecx")||name.equals("ch")||name.equals("cl")) {registerBubble[ECX].read(); bus[BUSECXOUT].access(); }
				else if (name.equals("dx")||name.equals("edx")||name.equals("dh")||name.equals("dl")) {registerBubble[EDX].read(); bus[BUSEDXOUT].access(); }
				else if (name.equals("si")||name.equals("esi")) {registerBubble[ESI].read(); bus[BUSESIOUT].access(); }
				else if (name.equals("di")||name.equals("edi")){ registerBubble[EDI].read(); bus[BUSEDIOUT].access(); }
				else if (name.equals("sp")||name.equals("esp")){registerBubble[ESP].read(); bus[BUSESPOUT].access(); }
				else if (name.equals("bp")||name.equals("ebp")){registerBubble[EBP].read(); bus[BUSEBPOUT].access(); }
				else if (name.equals("cs")) { registerBubble[CS].read(); bus[BUSCSOUT].access(); }
				else if (name.equals("ss")) { registerBubble[SS].read(); bus[BUSSSOUT].access(); }
				else if (name.equals("ds")) { registerBubble[DS].read(); bus[BUSDSOUT].access(); }
				else if (name.equals("es")) { registerBubble[ES].read(); bus[BUSESOUT].access(); }
				else if (name.equals("fs")) { registerBubble[FS].read(); bus[BUSFSOUT].access(); }
				else if (name.equals("gs")) { registerBubble[GS].read(); bus[BUSGSOUT].access(); }
				else if (name.equals("cr0")) { registerBubble[CR0].read(); bus[BUSCR0OUT].access(); }
				else if (name.equals("cr2")) {  registerBubble[CR2].read(); bus[BUSCR2OUT].access(); }
				else if (name.equals("cr3")) {  registerBubble[CR3].read(); bus[BUSCR3OUT].access(); }
				else if (name.equals("immediate")) {  instructionBlock.readImm(); bus[BUSIMMEDIATE].access(); }
				else if (name.charAt(0)=='m')
				{
					internalBlock[SEG].read(); bus[BUSSEGOUT].access(); internalBlock[ADDR].read(); bus[BUSADDROUT].access(); internalBlock[MEMORY].read(); bus[BUSMEMORYOUT].access();
				}
			...
			case DECODE_OUTPUT_OPERAND_0:
				if (name.equals("ax")||name.equals("eax")||name.equals("ah")||name.equals("al")) {registerBubble[EAX].write(value); bus[BUSEAXIN].access(); }
				else if (name.equals("bx")||name.equals("ebx")||name.equals("bh")||name.equals("bl")) {registerBubble[EBX].write(value); bus[BUSEBXIN].access(); }
				else if (name.equals("cx")||name.equals("ecx")||name.equals("ch")||name.equals("cl")) {registerBubble[ECX].write(value); bus[BUSECXIN].access(); }
				else if (name.equals("dx")||name.equals("edx")||name.equals("dh")||name.equals("dl")) {registerBubble[EDX].write(value); bus[BUSEDXIN].access(); }
				else if (name.equals("si")||name.equals("esi")) {registerBubble[ESI].write(value); bus[BUSESIIN].access(); }
				else if (name.equals("di")||name.equals("edi")) {registerBubble[EDI].write(value); bus[BUSEDIIN].access(); }
				else if (name.equals("sp")||name.equals("esp")) {registerBubble[ESP].write(value); bus[BUSESPIN].access(); }
				else if (name.equals("bp")||name.equals("ebp")) {registerBubble[EBP].write(value); bus[BUSEBPIN].access(); }
				else if (name.equals("cs")) { registerBubble[CS].write(value); bus[BUSCSIN].access(); }
				else if (name.equals("ss")) { registerBubble[SS].write(value); bus[BUSSSIN].access(); }
				else if (name.equals("ds")) { registerBubble[DS].write(value); bus[BUSDSIN].access(); }
				else if (name.equals("es")) { registerBubble[ES].write(value); bus[BUSESIN].access(); }
				else if (name.equals("fs")) { registerBubble[FS].write(value); bus[BUSFSIN].access(); }
				else if (name.equals("gs")) { registerBubble[GS].write(value); bus[BUSGSIN].access(); }
				else if (name.equals("cr0")) { registerBubble[CR0].write(value); bus[BUSCR0IN].access(); }
				else if (name.equals("cr2")) { registerBubble[CR2].write(value); bus[BUSCR2IN].access(); }
				else if (name.equals("cr3")) { registerBubble[CR3].write(value); bus[BUSCR3IN].access(); }
				else if (name.charAt(0)=='m')
				{
					internalBlock[SEG].read(); bus[BUSSEGOUT].access(); internalBlock[ADDR].read(); bus[BUSADDROUT].access(); internalBlock[MEMORY].write(value); bus[BUSMEMORYIN].access();
				}
...
//			if (computer.debugMode && computer.applet==null)
	...
	private class RegisterBubble
	{
		...
		public RegisterBubble(int register, int x, int y)
		{
			...
			if (register==IDTR && computer.processor.idtr!=null) value=Integer.toHexString(computer.processor.idtr.getValue());
			if (register==GDTR && computer.processor.idtr!=null) value=Integer.toHexString(computer.processor.gdtr.getValue());
			if (register==LDTR && computer.processor.idtr!=null) value=Integer.toHexString(computer.processor.ldtr.getValue());
			if (register==TSS && computer.processor.idtr!=null) value=Integer.toHexString(computer.processor.tss.getValue());
